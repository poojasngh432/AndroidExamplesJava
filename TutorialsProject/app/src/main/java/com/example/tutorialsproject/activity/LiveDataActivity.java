...
import com.example.tutorialsproject.adapter.NoteAdapter;
import com.example.tutorialsproject.database.Note;
import com.example.tutorialsproject.viewmodel.NoteViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LiveDataActivity.this, AddEditNoteActivity.class);
        ...
        noteViewModel.getAllNotes().observe(this, new Observer<List<Note>>() {
            ...
            public void onChanged(List<Note> notes) {
                //will be triggered each time our data changes
                //Update RecyclerView

                Toast.makeText(LiveDataActivity.this, "onChanged", Toast.LENGTH_SHORT).show();
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(LiveDataActivity.this, "Note deleted", Toast.LENGTH_SHORT).show();
            }
