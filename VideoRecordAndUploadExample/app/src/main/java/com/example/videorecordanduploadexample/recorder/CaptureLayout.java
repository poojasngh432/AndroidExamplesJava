...
import com.example.videorecordanduploadexample.recorder.listener.ReturnListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private SimpleClickListener leftClickListener;    //左边按钮监听
    private SimpleClickListener rightClickListener;   //右边按钮监听
...
//                resetCaptureLayout();
    ...
    public void setLeftClickListener(SimpleClickListener leftClickListener) {
        this.leftClickListener = leftClickListener;
    }

    public void setRightClickListener(SimpleClickListener rightClickListener) {
