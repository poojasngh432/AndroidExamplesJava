...
import com.example.videorecordanduploadexample.recorder.util.AngleUtil;
import com.example.videorecordanduploadexample.recorder.util.CameraParamUtil;
import com.example.videorecordanduploadexample.recorder.util.CheckPermission;
import com.example.videorecordanduploadexample.recorder.util.DeviceUtil;
    ...
    public void setZoom(float zoom, int type) {
        ...
        switch (type) {
            ...
            case TYPE_CAPTURE:
                ...
                Log.d(TAG, "setZoom = " + nowScaleRate);
                break;
        }
    ...
    private synchronized void openCamera(int id) {
        ...
        if (Build.VERSION.SDK_INT > 17 && this.mCamera != null) {
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "enable shutter sound failed");
            }
        }
    }
...
//
        Log.d(TAG, angle + " = " + cameraAngle + " = " + nowAngle);
...
//        }
        ...
        if (TextUtils.isEmpty(saveVideoPath)) {
            throw new IllegalStateException("saveVideoPath can not be empty!");
        }
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "startRecord IllegalStateException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (IOException e) {
            e.printStackTrace();
            Log.e(TAG, "startRecord IOException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (RuntimeException e) {
            Log.e(TAG, "startRecord RuntimeException");
        }
    }
