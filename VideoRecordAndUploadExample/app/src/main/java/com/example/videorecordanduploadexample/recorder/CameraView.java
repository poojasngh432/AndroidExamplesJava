package com.example.videorecordanduploadexample.recorder;
...
import com.example.videorecordanduploadexample.recorder.listener.CaptureListener;
...
import com.example.videorecordanduploadexample.recorder.listener.TypeListener;
import com.example.videorecordanduploadexample.recorder.state.CameraMachine;
import com.example.videorecordanduploadexample.recorder.util.FileUtil;
import com.example.videorecordanduploadexample.recorder.util.ScreenUtils;
import com.example.videorecordanduploadexample.recorder.view.ICameraView;
...
public class CameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder.Callback, ICameraView {
    ...
    private SimpleClickListener leftClickListener;
    private SimpleClickListener rightClickListener;
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        minDuration = a.getInteger(R.styleable.CameraView_duration_min, 1500); //没设置默认为1.5s
        a.recycle();
        initData();
        initView();
    }
...
//        mCaptureLayout.setIconSrc(-1, 0);
        ...
        mFoucsView = (FocusView) view.findViewById(R.id.fouce_view);
        mVideoView.getHolder().addCallback(this);
        //切换摄像头
        mSwitchCamera.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                machine.switchz(mVideoView.getHolder(), screenProp);
            }
        });
        //拍照 录像
...
//            }
//        });
        mCaptureLayout.setLeftClickListener(new SimpleClickListener() {
            @Override
            public void onClick() {
                if (leftClickListener != null) {
                    leftClickListener.onClick();
        ...
        mCaptureLayout.setRightClickListener(new SimpleClickListener() {
            @Override
            public void onClick() {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (event.getPointerCount() == 2) {
                    ...
                    Log.d(TAG, "result = " + (result - firstTouchLength));
                }
                break;
    ...
    public void setCameraLisenter(CameraListener jCameraLisenter) {
        this.cameraListener = jCameraLisenter;
    }
...
//        mFlashLamp.setVisibility(VISIBLE);
    ...
    public void setLeftClickListener(SimpleClickListener clickListener) {
        this.leftClickListener = clickListener;
    }

    public void setRightClickListener(SimpleClickListener clickListener) {
